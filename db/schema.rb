...
ActiveRecord::Schema[7.0].define(version: 0) do
  ...
  create_table "MEMBER", primary_key: "NO", id: :bigint, default: nil, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "MEMBER_WORD_RELATION", primary_key: "NO", id: :bigint, default: nil, charset: "utf8mb3", force: :cascade do |t|
    t.bigint "MEMBER_NO", null: false
  ...
  create_table "WORD", primary_key: "NO", id: :integer, default: nil, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "WORDBANK", primary_key: "NO", id: :bigint, default: nil, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "WORD_WORDBANK_RELATION", primary_key: "NO", id: :bigint, default: nil, charset: "utf8mb3", force: :cascade do |t|
    t.bigint "OWNER_NO", null: false
  ...
  add_foreign_key "AUTHORITIES", "MEMBER", column: "MEMBER_NO", primary_key: "NO", name: "FK_MEMBER_NO_3"
  add_foreign_key "MEMBER_WORD_RELATION", "MEMBER", column: "MEMBER_NO", primary_key: "NO", name: "FK_MEMBER_NO_2"
  add_foreign_key "MEMBER_WORD_RELATION", "WORD", column: "WORD_NO", primary_key: "NO", name: "FK_WORD_NO_2"
  add_foreign_key "WORDBANK", "MEMBER", column: "OWNER_NO", primary_key: "NO", name: "FK_MEMBER_NO"
  add_foreign_key "WORD_WORDBANK_RELATION", "WORDBANK", column: "WORDBANK_NO", primary_key: "NO", name: "FK_WORDBANK_NO"
end
